    ...
    >
      <VaCardContent class="flex flex-col h-full">
        ...
        <div class="flex justify-between">
          <VaButton preset="secondary" icon="fa4-edit" color="secondary" @click="$emit('edit', project)" />
          <VaButton preset="secondary" icon="fa4-trash" color="danger" @click="$emit('delete', project)" />
        </div>
      </VaCardContent>
    </VaCard>
  </VaInnerLoading>
